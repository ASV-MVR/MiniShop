...
import com.example.minishop.adapters.ItemsAdapter;
...
public class MainActivity extends AppCompatActivity implements OnChangeListener, View.OnClickListener {
        ...
        private void initViews() {
            ...
            tv_text.setText("Cписок товаров");
        ...
        private void fillData() {
            ...
            for(int i = 0; i < ARR_SIZE; i++) {
                price += 100;
                items.add(new Item(i, "Товар " + i, price,false));
            }
        }
        ...
        public void onDataChanged() {
            ...
            items_count.setText(size + " товаров");
        }
        ...
        public void onClick(View view) {
            if(view.getId() == R.id.list_checked_button) {
                ...
                intent.putParcelableArrayListExtra("Мой лист", checked_items);
